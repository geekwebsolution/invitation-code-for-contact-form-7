<?php
if (!class_exists('CF7IC_Update_Checker')) {

    class CF7IC_Update_Checker {
        ...
        public function check_for_updates($transient) {
            ...
            $transient_name = 'cf7ic_plugin_updates';
